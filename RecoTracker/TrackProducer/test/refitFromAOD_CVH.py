...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(['/store/mc/RunIISummer20UL16RECO/DYJetsToMuMu_H2ErratumFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/AODSIM/106X_mcRun2_asymptotic_v13-v2/2820000/048D64FD-0AE4-814C-9984-AF3A85625E5C.root']),
...
process.trackrefit = cms.EDProducer('ResidualGlobalCorrectionMakerG4e',
                                    src = cms.InputTag("trackExtraRekeyer"),
...
process.reconstruction_step = cms.Path(process.trackExtraRekeyer*process.geopro*process.trackrefitideal, 
