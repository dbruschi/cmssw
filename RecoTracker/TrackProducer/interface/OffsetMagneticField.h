#ifndef TrackProducer_OffsetMagneticField_h
#define TrackProducer_OffsetMagneticField_h
...
public:
  OffsetMagneticField() {};
  OffsetMagneticField(const MagneticField* nominal, GlobalVector const& offset) : field_(nominal), offset_(offset) {}
